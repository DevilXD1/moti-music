...
from MotiVcPlayer.config import (
    BOT_USERNAME,
    PROJECT_NAME,
    SOURCE_CODE,
    SUPPORT_GROUP,
...
from MotiVcPlayer.modules.msg import Messages as tr
...
def map(pos):
    if pos == 1:
        ...
        button = [
            ...
            [
                InlineKeyboardButton(
                    text="🛠 Source Code 🛠", url=f"https://github.com/Attitudeshauryaking/moti-music"
                )
            ],
